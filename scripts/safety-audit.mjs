...
must(/@version\s+2\.5\.0/.test(bridge), 'bridge version is not 2.5.0');
must(/@version\s+2\.5\.0/.test(ui), 'UI version is not 2.5.0');
...
console.log('Safety audit PASS: v2.5 passive-only invariants satisfied.');
